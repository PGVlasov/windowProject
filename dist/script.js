...
/* harmony import */ var _moduls_madals__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./moduls/madals */ "./src/js/moduls/madals.js");
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_moduls_madals__WEBPACK_IMPORTED_MODULE_1__["default"])();
...
/* harmony import */ var _checkNumInputs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./checkNumInputs */ "./src/js/moduls/checkNumInputs.js");
...
/* harmony import */ var _checkNumInputs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./checkNumInputs */ "./src/js/moduls/checkNumInputs.js");
  ...
  form.forEach(function (item) {
    item.addEventListener("submit", function (e) {
      ...
      postData("assets/server.php", formData).then(function (res) {
        ...
        return statusMessage.textContent = message.falure;
      }).finally(function () {
        clearInputs();
        setTimeout(function () {
...
var timer = function timer(id, deadLine) {
  ...
  var setClock = function setClock(selector, endtime) {
    try {
      var _timer = document.querySelector(selector);

      var _days = _timer.querySelector("#days");

      var _hours = _timer.querySelector("#hours");

      var _minutes = _timer.querySelector("#minutes");

      var _seconds = _timer.querySelector("#seconds");
